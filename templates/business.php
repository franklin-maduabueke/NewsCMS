		...
		<div id="pageContentMainBlock">
			...
			<div id="pageLeftColumn">
				...
				<?php
					...
					$sql = sprintf("SELECT art.Heading, art.TextContent, art.ArticleGenID, art.SCGenID, sc.CatGenID FROM articles AS art JOIN subcategory AS sc ON sc.SCGenID=art.SCGenID WHERE art.ArticleGenID NOT IN(%s) AND art.SCGenID IN(SELECT SCGenID FROM subcategory WHERE CatGenID='%s') AND PublishDate<>'0000-00-00' ORDER BY PublishDate DESC", $listOfDisplayedArticles, $category_id);
