	...
	if ($ini)
	{
		...
		if (isset($xmls) && file_exists($xmls))
		{
			...
			if ($lookConf->isXMLFileLoaded())
			{
				...
				{
?>
<form action="../processing/setCategoryTemplate.php" method="post">
	...
	<table id="publishedListingTable" cellpadding="0" cellspacing="0">
		...
		?>
			<tr>
				...
				<td>
					<input type="text" name="section<?php echo $i + 1; ?>Heading" style="width:530px; border:1px solid #CCCCCC" maxlength="100" />
				</td>
				<td>
					<select name="section<?php echo $i + 1; ?>subCategoryChoice" style="width:300px">
						<?php
