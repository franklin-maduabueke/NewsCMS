<?php
	...
	$content = file_get_contents("config/aboutUs.txt");
...
<title>www.nigerianewsnetwork.com : About Us</title>
</head>
	...
	<div id="pageContentHolder">
	  <div id="pageContentMainBlock">
			...
			<div id="aboutusPageLeftColumn">
				<div id="aboutusPLColHeading">About Nigeria News Network</div>
