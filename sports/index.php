...
<?php
	...
	{
		$sql = sprintf("SELECT CategoryName, CatGenID FROM Category WHERE CatGenID='%s'", PAGE_NAME);
...
<link rel="stylesheet" type="text/css" href="<?php echo $prefix;?>stylesheet/sportsLook.css">
...
?>
	...
	<div id="pageContentHolder">
		<div id="pageContentMainBlock">
			...
			<?php
				//query for top story.
				$sql = sprintf("SELECT Heading, TextContent, ArticleGenID, SCGenID FROM Articles WHERE TopStory=1 AND SCGenID IN(SELECT SCGenID FROM Subcategory WHERE CatGenID='%s')", PAGE_NAME);
			...
			<div id="pageLeftColumn">
					...
					<div id="topStoriesContent">
						<div id="topStoriesBigScreenHolder">
							<div id="topStoriesBigScreen">
								<a href="<?php echo $prefix; ?>processing/redirectToRead.php?sel=<?php echo PAGE_NAME; ?>&sc=<?php echo $topstoryArticleRow['SCGenID']."&article=".$topstoryArticleRow['ArticleGenID']?>"><img src="<?php echo $prefix;?>processing/fetch_article_photo.php?photoId=<?php echo $topstoryPhotoRow['ArtPhotoID'];?>" /></a>
							</div>
					  </div>
						<div id="topStoriesThumbnailHolder">
							<div class="topStoriesHeading"><?php echo substr($topstoryArticleRow['Heading'], 0, 40); ?></div>
							
							<div class="topStoriesStoryEx"><?php echo substr($topstoryArticleRow['TextContent'], 0, 146) . "...";?></div>
							...
							<div id="topStoriesMoreLinkHolder">
								<ul>
									<?php
										...
										{
									?>
										<li><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $tsRelatedRow['CatGenID'];?>&sc=<?php echo $tsRelatedRow['SCGenID'];?>&article=<?php echo $tsRelatedRow['ArticleGenID'];?>"><?php echo substr($tsRelatedRow['Heading'], 0, 40);?></a></li>
									<?php
										}
									?>
								</ul>
				...
				<?php
					...
					$sql = sprintf("SELECT art.Heading, art.TextContent, art.ArticleGenID, art.SCGenID, sc.CatGenID FROM Articles AS art JOIN Subcategory AS sc ON sc.SCGenID=art.SCGenID WHERE ArticleGenID<>'%s' AND art.SCGenID IN(SELECT SCGenID FROM Subcategory WHERE CatGenID='%s') AND PublishDate<>'0000-00-00' ORDER BY PublishDate DESC", $topstoryArticleRow['ArticleGenID'], PAGE_NAME);
				...
				<div id="midLeftColumn">
					...
					<div id="midLNews1" class="midLNewsSections">
						<label class="midNewsSectionsHeading"><?php echo substr($otherArticlesRow['Heading'], 0, 55); ?></label>
					...
					<div id="midLNews2" class="midLNewsSections">
						<label class="midNewsSectionsHeading"><?php echo substr($otherArticlesRow['Heading'], 0, 40); ?></label>
						...
						<p/>
						<span class="midNewsExText">
							<?php echo substr($otherArticlesRow['TextContent'], 0, 120) . "...";?><br/><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $otherArticlesRow['CatGenID'];?>&sc=<?php echo $otherArticlesRow['SCGenID'];?>&article=<?php echo $otherArticlesRow['ArticleGenID'];?>" class="readMoreLink">more &raquo;</a>
						</span>
					</div>
						<?php
							}
					...
					<div id="midLNews3" class="midLNewsSections" style="border:0px;">
						...
						<p/>
						<span class="midNewsExText">
							<?php echo substr($otherArticlesRow['TextContent'], 0, 250) . "...";?><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $otherArticlesRow['CatGenID'];?>&sc=<?php echo $otherArticlesRow['SCGenID'];?>&article=<?php echo $otherArticlesRow['ArticleGenID'];?>" class="readMoreLink">more &raquo;</a>
						</span>
				...
				<div id="midRightColumn">
						...
						?>
					<div id="midRNewsWithImage1" class="midRNews" style="margin-top:5px; border-bottom:1px solid #D1D1D1; border-top:0px; height:135px;">
							<div id="midRNWithImageScreen" style="border:0px">
								<img src="<?php echo $prefix;?>processing/fetch_article_photo.php?photoId=<?php echo $otherArticlesPhotoRow['ArtPhotoID'];?>" />
							</div>
							<div id="midRNWithImageExHolder">
								<div style="text-align:left; width:250px" class="midNewsSectionsHeading"><label class="midNewsSectionsHeading"><?php echo substr($otherArticlesRow['Heading'], 0, 55); ?></label></div>
								<span class="midNewsExText">
								<?php echo substr($otherArticlesRow['TextContent'], 0, 115) . "...";?><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $otherArticlesRow['CatGenID'];?>&sc=<?php echo $otherArticlesRow['SCGenID'];?>&article=<?php echo $otherArticlesRow['ArticleGenID'];?>" class="readMoreLink">more &raquo;</a>
								</span>
							</div>
					</div>
						<?php
						...
						?>
					<div id="midRNewsWithImage2" class="midRNews" style="margin-top:5px; border-top:0px; height:135px;">
							<div id="midRNWithImageScreen" style="border:0px">
								<img src="<?php echo $prefix;?>processing/fetch_article_photo.php?photoId=<?php echo $otherArticlesPhotoRow['ArtPhotoID'];?>" />
							</div>
							<div id="midRNWithImageExHolder">
					...
					<div id="midRNewsNoImage1" class="midRNews">
						<div style="text-align:left; margin-top:10px; width:360px"><label class="midNewsSectionsHeading"><?php echo substr($otherArticlesRow['Heading'], 0, 40); ?></label></div>
						<div id="midRNewsNoImage1Tex" style="margin-top:8px; margin-bottom:20px;">
							<span class="midNewsExText"><?php echo substr($otherArticlesRow['TextContent'], 0, 402) . "...";?><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $otherArticlesRow['CatGenID'];?>&sc=<?php echo $otherArticlesRow['SCGenID'];?>&article=<?php echo $otherArticlesRow['ArticleGenID'];?>" class="readMoreLink">more &raquo;</a></span>
						</div>
					</div>
						<?php
							}
					...
					<div id="midRNewsNoImage2" class="midRNews">
						...
						<div id="midRNewsNoImage2Tex" style="margin-top:8px; margin-bottom:20px;">
							<span class="midNewsExText"><?php echo substr($otherArticlesRow['TextContent'], 0, 168) . "...";?><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $otherArticlesRow['CatGenID'];?>&sc=<?php echo $otherArticlesRow['SCGenID'];?>&article=<?php echo $otherArticlesRow['ArticleGenID'];?>" class="readMoreLink">more &raquo;</a></span>
						</div>
					</div>
						<?php
							}
					...
					<div id="midRNewsBottomSection"> <!-- section 1 -->
						<div class="sectionHeading" id="midBottomHeading">
							<div style="font-size:17px; padding-left:5px; margin-left:0px; margin-top:5px; background-color:#EBEBEB; height:32px; width:422px; margin-bottom:5px"><?php echo $details['heading']; ?></div>
						</div>
						...
						<div class="moreSportsNewsContainer" id="mSNC1">
							...
							<div class="moreSnipetHolder moreSnipetHolderR">
								<div class="mSImageHolder"><img src="<?php echo $prefix;?>processing/fetch_article_photo.php?photoId=<?php echo $sectionArticlesPhotoRow['ArtPhotoID'];?>" /></div>
								<div class="mSImageHeading">
									<?php echo htmlentities($sectionRow['Heading']); ?>
								</div>
								<div class="mSEx">
									<label>Football:</label> <?php echo substr($sectionRow['TextContent'], 0, 98) . "...";?><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $sectionRow['CatGenID'];?>&sc=<?php echo $sectionRow['SCGenID'];?>&article=<?php echo $sectionRow['ArticleGenID'];?>" class="readMoreLink">more &raquo;</a>
								</div>
						...
						<div class="moreSportsNewsContainer" id="mSNC2">
							<?php
								$sectionRow = $sectionResult->fetch_array();
								if ($sectionRow)
								{
						...
						<div class="moreSportsNewsContainer" id="mSNC3" style="border:0px; height:160px">
							<?php
								$sectionRow = $sectionResult->fetch_array();
								if ($sectionRow)
								{
							...
							<div id="topStoriesMoreLinkHolder">
								<ul>
									<?php
										...
										{
									?>
										<li><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $tsRelatedRow['CatGenID'];?>&sc=<?php echo $tsRelatedRow['SCGenID'];?>&article=<?php echo $tsRelatedRow['ArticleGenID'];?>"><?php echo substr($tsRelatedRow['Heading'], 0, 30);?></a></li>
									<?php
										}
									?>
								</ul>
			...
			<div id="pageRightColumn">
				<?php require_once($prefix . "includes/adsSquare.php"); ?>
				...
				<div id="onTheNewsSection">
					...
					<div class="otnSnipetsHolder">
						...
						<div class="otnThumbEx">
							<?php echo trim(substr($l24HoursRow['TextContent'], 0, 70)) . "...";?><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $l24HoursRow['CatGenID']."&sc=".$l24HoursRow['SCGenID']."&article=".$l24HoursRow['ArticleGenID']?>" class="readMoreLink">more &raquo;</a>
						</div>
					</div>
							<?php
										}
							...
							?>
					<div class="otnSnipetsHolder otnNoThumbEx">
						<div class="otnNoThumbExText">
							<?php echo substr($l24HoursRow['TextContent'], 0, 70) . "...";?><a href="<?php echo $prefix;?>processing/redirectToRead.php?sel=<?php echo $l24HoursRow['CatGenID']."&sc=".$l24HoursRow['SCGenID']."&article=".$l24HoursRow['ArticleGenID']?>" class="readMoreLink">more &raquo;</a>
						</div>
					</div>
							<?php
										}
