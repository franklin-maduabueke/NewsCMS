			...
			<div id="pageLeftColumn" style="width:663px; border-right:1px solid #D1D1D1;">
				<div id="mainContentArea">
					...
					<div id="commentCountHolder">
						<a style="color:#0099CC; font-size:14px; text-decoration:none;"><?php echo $comments; ?> Comment(s)</a> 
					</div>
					<?php
				  ...
				  <div id="newsTextHolder">
				 		<?php
							...
							if ($ini && array_key_exists("SITE_MISC", $ini) && array_key_exists("SiteURL", $ini["SITE_MISC"]))
								$siteURL = $ini['SITE_MISC']['SiteURL'];
						?>
						<a href="#top" style="color:#DF0000; font-size:12px; text-decoration:none">back to top &raquo;</a>
				  </div>
				  <div id="fblikebuttonholder">
				  	<iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo $siteURL . $_SERVER['REQUEST_URI'];?>&amp;send=false&amp;layout=standard&amp;width=450&amp;show_faces=true&amp;action=like&amp;colorscheme=light&amp;font&amp;height=80" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:80px;" allowTransparency="true"></iframe>
				  </div>
				</div>
